            ...
            <div class="box box-primary">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button id="delete" type="submit" class="btn btn-default" title="删除" onclick=""><i class="fa fa-trash-o"></i>删除</button>
                                    ...
                                    <button type="button" class="btn btn-default" title="刷新" onclick="location.reload()"><i class="fa fa-refresh" ></i> 刷新</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/product/findOrders?id=${product.id}'">订单</button>
                ...
                <div class="box-footer">
                    <div class="pull-left" style="margin-top: 20px">
                        <div class="form-group form-inline">
                            总共${pageInfo.pages} 页，共${pageInfo.total}条数据。 每页${pageInfo.pageSize}
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/product/findAll?page=${pageInfo.prePage}&size=${pageInfo.pageSize}">上一页</a></li>

                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li><a href="${pageContext.request.contextPath}/product/findAll?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
                            </c:forEach>

                            <li><a href="${pageContext.request.contextPath}/product/findAll?page=${pageInfo.nextPage}&size=${pageInfo.pageSize}">下一页</a></li>
                            <li>
